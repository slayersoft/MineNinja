...
?>
      <thead>
      	<tr>
            ...
            <input type="submit" class="button"  value="Add Pool" name="addpool">
            </th>
          </tr>
          <tr>
            <th colspan="12">
            ...
            <input type="submit" class="button" value="Save Configuration" name="saveconf">
          </th>
        </tr>
<?php
      ...
      <table class='acuity' summary='cgminerreset' align='center'>
        <tr>
      	...
      	<tr>
             ...
             <input type="submit" class="button" value="Reset" name="restartbut">&nbsp;
      	   </th>
      	   <th>
             <input type="checkbox" value="Quit" name="quitchk">&nbsp;
             <input type="submit" class="button" value="Quit" name="quitbut">
           </th>
        </tr>      
      </table>
<?php
